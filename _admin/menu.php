...
<div class="wfull hfull bgcMenu">
    ...
    <div class="wfull">
        ...
        <a class="w3-button w3-block w3-left-align wfull w3-text-white fs095e" href="../os">OS</a>
        ...
        <div id="menu1" class="w3-hide bgcMenu w3-card fs087e">
            <a href="../users" class="w3-button w3-text-white wfull" style="margin-left: -45px;">Venda</a>
            <a href="../empresa" class="w3-button w3-text-white wfull" style="margin-left: -42px;">Lançamento</a>
        </div>
