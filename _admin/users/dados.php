...
<?php include 'usr_dados.php';?>
    ...
    <div class="bgcC1 h40 pt10 pl20" style="margin-left: 15%">
        <p class="fs087e w3-text-gray "><a href="../../_admin/index.php" class="w3-hover-text-dark-gray"><i class="fa fa-home"></i> Home ></a><a href="../users" class="w3-hover-text-dark-gray ml10">Usuários ></a><a
