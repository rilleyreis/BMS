...
<div class="bgcC1 h40 pt10 pl20" style="margin-left: 15%">
    <p class="fs087e w3-text-gray "><a href="../../_admin/index.php" class="w3-hover-text-dark-gray"><i class="fa fa-home"></i> Home ></a><a href="../service" class="w3-hover-text-dark-gray ml10">Servicos ></a><a
    ...
    <div class="w3-card mt35">
        ...
        <div class="p10">
            ...
            <form action="" method="post">
                <input type="text" name="id_serv" hidden="hidden" value="<?php echo $id;?>">
                <div class="w3-row">
                    ...
                    <div class="w3-rest">
                        <input type="text" name="nome_serv" class="w3-input w3-border w3-border-gray w3-hover-border-blue bradius mb10 fs087e letra" style="border-radius: 0 6px 6px 0;" maxlength="20" placeholder="Nome" value="<?php echo $nome;?>" required>
                    </div>
                </div>
                <div class="w3-row">
                    <div class="w3-col w3-border w3-border-gray w3-gray" style="width: 145px; border-radius: 6px 0 0 6px; padding: 6.5px;">
                    ...
                    <div class="w3-rest">
                        <input type="text" name="desc_serv" class="w3-input w3-border w3-border-gray w3-hover-border-blue bradius mb10 fs087e" style="border-radius: 0 6px 6px 0;" maxlength="50" placeholder="Descrição" value="<?php echo $desc;?>" required>
                    </div>
                </div>
                <div class="w3-row">
                    <div class="w3-col w3-border w3-border-gray w3-gray" style="width: 145px; border-radius: 6px 0 0 6px; padding: 6.5px;">
                    ...
                    <div class="w3-rest">
                        <input type="text" name="preco_serv" class="w3-input w3-border w3-border-gray w3-hover-border-blue bradius mb10 money fs087e" style="border-radius: 0 6px 6px 0;" placeholder="Preço" value="<?php echo $preco;?>" required>
                    </div>
                </div>
                ...
                <button class="w3-btn w3-blue-gray w3-center fs087e bradius" type="reset" <?php echo $add;?>><i class="fa fa-eraser"></i> Limpar</button>
