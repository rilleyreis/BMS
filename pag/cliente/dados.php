    ...
    <div class="w3-container" style="margin-left: 15%;">
        <div class="w3-card mt35">
            ...
            <div class="w3-row p15">
                ...
                <div class="w3-rest">
                    <select name="status" id="" class="w3-input-25 w3-border w3-border-gray w3-hover-border-blue mb10 fs087e" style="border-radius: 0 6px 6px 0;" onchange="cliente(this);">
            ...
            <div class="p10">
                ...
                <form action="" method="post">
                    <div class="w3-row">
                        ...
                        <div class="w3-rest">
                            <input type="text" name="nomeCliente" class="w3-input w3-border w3-border-gray w3-hover-border-blue bradius mb10 fs087e letra" style="border-radius: 0 6px 6px 0;" maxlength="11" placeholder="Primeiro Nome" value="" required>
                        </div>
                    </div>
                    <div class="w3-row">
                        <div class="w3-col w3-border w3-border-gray w3-gray" style="width: 145px; border-radius: 6px 0 0 6px; padding: 6.5px">
                        ...
                        <div class="w3-rest">
                            <input type="text" name="snomeCliente" class="w3-input w3-border w3-border-gray w3-hover-border-blue bradius mb10 fs087e" style="border-radius: 0 6px 6px 0;" maxlength="50" placeholder="Sobrenome" value="" required>
                        </div>
                    </div>
                    <div class="w3-row">
                        <div class="w3-col w3-border w3-border-gray w3-gray" style="width: 145px; border-radius: 6px 0 0 6px; padding: 6.5px">
                        ...
                        <div class="w3-rest">
                            <input type="text" name="cpfCliente" class="w3-input w3-border w3-border-gray w3-hover-border-blue bradius mb10 cpf fs087e" style="border-radius: 0 6px 6px 0;" onblur="cpf(this);" placeholder="CPF" value="" required>
                        </div>
                    </div>
                    <div class="w3-row">
                        <div class="w3-col w3-border w3-border-gray w3-gray" style="width: 145px; border-radius: 6px 0 0 6px; padding: 6.5px;">
                        ...
                        <div class="w3-rest">
                            <input type="text" name="telefoneCliente" class="w3-input w3-border w3-border-gray w3-hover-border-blue bradius mb10 tel fs087e" style="border-radius: 0 6px 6px 0;" placeholder="Telefone" value="">
                        </div>
                    </div>
                    <div class="w3-row">
                        <div class="w3-col w3-border w3-border-gray w3-gray" style="width: 145px; border-radius: 6px 0 0 6px; padding: 6.5px;">
                        ...
                        <div class="w3-rest">
                            <input type="text" name="celularCliente" class="w3-input w3-border w3-border-gray w3-hover-border-blue bradius mb10 cel fs087e" style="border-radius: 0 6px 6px 0;" placeholder="Celular" value="">
                        </div>
                    </div>
                    <div class="w3-row">
                        <div class="w3-col w3-border w3-border-gray w3-gray" style="width: 145px; border-radius: 6px 0 0 6px; padding: 6.5px;">
                        ...
                        <div class="w3-rest">
                            <input type="email" name="emailCliente" class="w3-input w3-border w3-border-gray w3-hover-border-blue bradius mb10 fs087e" style="border-radius: 0 6px 6px 0;" maxlength="50" placeholder="Email" value="" required>
                        </div>
                    </div>
                    <div class="w3-row">
                        <div class="w3-col w3-border w3-border-gray w3-gray" style="width: 145px; border-radius: 6px 0 0 6px; padding: 6.5px;">
                        ...
                        <div class="w3-rest">
                            <input type="text" name="ruaCliente" class="w3-input w3-border w3-border-gray w3-hover-border-blue bradius mb10 fs087e" style="border-radius: 0 6px 6px 0;" maxlength="50" placeholder="Rua" value="" required>
                        </div>
                    </div>
                    <div class="w3-row">
                        <div class="w3-col w3-border w3-border-gray w3-gray" style="width: 145px; border-radius: 6px 0 0 6px; padding: 6.5px;">
                        ...
                        <div class="w3-rest">
                            <input type="text" name="numeroCliente" class="w3-input w3-border w3-border-gray w3-hover-border-blue bradius mb10 fs087e" style="border-radius: 0 6px 6px 0;" placeholder="Numero" value="" required>
                        </div>
                    </div>
                    <div class="w3-row">
                        <div class="w3-col w3-border w3-border-gray w3-gray" style="width: 145px; border-radius: 6px 0 0 6px; padding: 6.5px;">
                        ...
                        <div class="w3-rest">
                            <input type="text" name="bairroCliente" class="w3-input w3-border w3-border-gray w3-hover-border-blue bradius mb10 fs087e" style="border-radius: 0 6px 6px 0;" maxlength="50" placeholder="Bairro" value="" required>
                        </div>
                    </div>
