...
<div class="w3-main p15" style="margin-left: 300px; margin-top: 43px;">
    ...
    <div class="mt20">
        <div class="wfull mb05 p5">
            <form action="" method="post">
                <div class="w3-row">
                    <div class="w3-col w3-border w3-border-gray" style="border-radius: 6px 0 0 6px; width: 95%">
                        <input type="text" name="buscarDado" class="w3-input w3-hover-border-blue fs087e" placeholder="Buscar">
                    </div>
                    <div class="w3-col w3-border w3-border-gray w3-white" style="width: 5%; border-radius: 0 6px 6px 0;">
                        <button name="buscar" type="submit" class="w3-btn fs087e"><i class="fas fa-search"></i></button>
                    </div>
                </div>
            </form>
        </div>
                            ...
                            <div id="modal<?php echo $cont;?>" class="w3-modal">
                                <div class="w3-modal-content w3-animate-top w3-center w300">
                                    ...
                                    <div class="w3-container">
                                        ...
                                        <p class="w3-left-align fs11e w3-border-bottom w3-border-gray">RG: <?php echo $row['rg']?></p>
