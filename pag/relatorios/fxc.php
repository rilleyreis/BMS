...
<?php include "../../php/control/relatorios/rel_fxc.php"?>
    ...
    <div class="p5 print">
        ...
        <div class="print">
            <header class="w3-gray w3-text-gray p8">
                Relatório Ordem de Serviço - Finalizadas / Canceladas
            </header>
            <div class="p5 w3-border w3-border-gray">
                <table class="w3-table w3-striped w3-bordered w3-white">
                    ...
                    <tr>
                        <td>Finalizadas</td>
                        <td><?php echo $perFim?></td>
                    </tr>
                    <tr>
                        <td>Canceladas</td>
                        <td><?php echo $perCan?></td>
                    </tr>
                    <tr>
                        <td class="fwb">Total de OS</td>
