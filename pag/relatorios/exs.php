...
<?php include "../../php/control/relatorios/rel_exs.php"?>
    ...
    <div class="p5 print">
        ...
        <div class="print">
            <header class="w3-gray w3-text-gray p8">
                Relatório Movimentação - Entrada / Saída
            </header>
            <div class="p5 w3-border w3-border-gray">
                <table class="w3-table w3-striped w3-bordered w3-white">
                    ...
                    <tr>
                        ...
                        <td><?php echo $qtdTipo[0] + $qtdTipo[1]?></td>
                        <td><?php echo "R$".number_format($vlrTipo[0] + $vlrTipo[1], 2, ',','.')?></td>
                    </tr>
                    <tr>
                        <td><?php echo $tipo[2]?></td>
                        <td><?php echo $qtdTipo[2] + $qtdTipo[3]?></td>
                        <td><?php echo "R$".number_format($vlrTipo[2] + $vlrTipo[3], 2, ',','.')?></td>
                    </tr>
                    <tr>
