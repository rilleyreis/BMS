...
<?php include "../../php/control/relatorios/rel_mov.php"?>
            ...
            <div class="p5 w3-border w3-border-gray">
                <table class="w3-table w3-striped w3-bordered w3-white">
                    ...
                    <tr>
                        ...
                        <td><?php echo $qtdTipo[0]?></td>
                        <td><?php echo "R$".number_format($vlrTipo[0], 2, ',','.')?></td>
                    </tr>
                    <tr>
                        <td><?php echo $tipo[1]?></td>
                        <td><?php echo $qtdTipo[1]?></td>
                        <td><?php echo "R$".number_format($vlrTipo[1], 2, ',','.')?></td>
                    </tr>
                    <tr>
                        <td><?php echo $tipo[2]?></td>
                        <td><?php echo $qtdTipo[2]?></td>
                        <td><?php echo "R$".number_format($vlrTipo[2], 2, ',','.')?></td>
                    </tr>
                    <tr>
                        <td><?php echo $tipo[3]?></td>
                        <td><?php echo $qtdTipo[3]?></td>
                        <td><?php echo "R$".number_format($vlrTipo[3], 2, ',','.')?></td>
                    </tr>
                    <tr>
                        <td class="fwb">Total</td>
                        <td class="fwb"><?php echo $totalQtd?></td>
                        <td class="fwb"><?php echo "R$".number_format($totalVlr, 2, ',','.')?></td>
                    </tr>
                    <tr></tr>
                </table>
                <input type="hidden" value="<?php echo $periodo?>" id="periodo"></input>
            </div>
        </div>
    </div>
